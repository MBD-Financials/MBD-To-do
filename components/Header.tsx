  ...
  return (
    <header>
      <div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl">
        ...
        />
        <Image
          src="https://mbdfinancials.com/wp-content/uploads/2023/04/MBD-Logo-Transparent-1-1.png"
          alt="Trello Logo"
          width={300}
          height={100}
          className="font-bold w-20 md:w-20 pb-10 md:pb-0 object-contain"
        />
        ...
        <div className="flex items-center space-x-5 flex-1 w-full justify-end">
          ...
          <Avatar name="Metaverse Business District" round size="50" color="#0055D1" />
        </div>
      </div>
      ...
      <div className="flex items-center justify-center px-5 md:py-5">
        <p className="flex items-center text-sm font-light pr-5 shadow-xl rounded-xl w-fit bg-white italic p-5 max-w-3xl text-[#0055D1]">
          ...
          {suggestion && !loading
            ? suggestion
            : "Hey May is summarising your tasks for the day..."}
        </p>
      </div>
    </header>
  );
